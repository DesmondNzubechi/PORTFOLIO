...
<div data-aos='fade-up' data-aos-duration='1000' className="    rounded ">
  ...
  <div data-aos='fade-up' data-aos-duration='1000' className="">
    ...
    <p className="md:text-[17px] text-[15px] ">Hi, my name is <strong className="uppercase text-slate-900 font-bold">Desmond Nzubechukwu Abugu</strong> , and I am a frontend web developer with expertise in HTML, CSS, JavaScript, ReactJS, Nextjs, Firebase, and TailwindCSS. With my experience in the tech industry, I have had the opportunity to work on a couple of projects, both simple websites and complex web applications.</p>
