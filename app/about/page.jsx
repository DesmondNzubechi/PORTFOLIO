...
<div data-aos='fade-up' data-aos-duration='1000' className="    rounded ">
  ...
  <div data-aos='fade-up' data-aos-duration='1000' className=" flex flex-col gap-5">
    ...
    <p className="md:text-[18px] text-slate-700   text-[15px] ">My name is <strong className="uppercase text-slate-900 font-bold">Desmond Nzubechukwu Abugu</strong>, and I am  a <strong className='capitalize'>frontend developer.</strong></p>
  {/* <p className="md:text-[18px] text-slate-700 text-[12px] ">In my journey as a web developer, I've led a collaborative effort to create an online learning platform  for Electrical Engineering students at my institution.  This platform provides students with easy access to their course outlines, downloadable learning resources, and a convenient CGPA calculator. It includes a dynamic blog that keeps students updated with the latest news and developments in the field of Electrical Engineering. Serving as the project manager, I oversaw the frontend development and ensured effective communication throughout the project's lifecycle.</p> */}
              <p className="md:text-[18px] text-slate-700   text-[15px] ">In my journey as a web developer, I've led a collaborative effort to create an online learning platform for Electrical Engineering students at my institution.</p> 
              <p className="md:text-[18px] text-slate-700   text-[15px] ">This platform provides students with easy access to their course outlines, downloadable learning resources, and a convenient CGPA calculator.</p> 
              <p className="md:text-[18px] text-slate-700   text-[15px] ">It includes a dynamic blog that keeps students updated with the latest news and developments in the field of Electrical Engineering. </p> 
              <p className="md:text-[18px] text-slate-700   text-[15px] ">Serving as the project manager, I oversaw the frontend development and ensured effective communication throughout the project's lifecycle.</p> 
