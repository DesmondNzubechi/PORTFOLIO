...
<div data-aos='fade-up' data-aos-duration='1000' className="    rounded ">
  ...
  <div data-aos='fade-up' data-aos-duration='1000' className=" flex flex-col gap-5">
    ...
    <p className="md:text-[18px] text-slate-700 text-[12px] ">My name is <strong className="uppercase text-slate-900 font-bold">Desmond Nzubechukwu Abugu</strong>  a <strong className='capitalize'>frontend developer</strong></p>
  ...
  <h1 className="text-slate-900 md:text-[30px] text-[25px] font-bold uppercase text-slate-900  font-headerFont">My Tools</h1> 
  <div className='grid gap-2 uppercase grid-cols-4'>
