...
export default function Home() {
  return (
    <main className="flex min-h-screen md:flex-row gap-5 bg-slate-50  flex-col py-[100px] items-center justify-around p-10">
      <div className='flex max-w-[500px] flex-col gap-5'>
        ...
        <div className='flex gap-5 items-center'>
          <BsGithub className='text-blue-500 text-[30px] ' />
          <BsLinkedin className='text-blue-500 rounded-full  text-[30px] '/>
          <AiFillTwitterCircle className='text-blue-500 text-[30px] '/>
        </div>
        <div className='flex gap-5 items-center'>
