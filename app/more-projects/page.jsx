...
const Projects = () => {
  const projectItems = [
    ...
    },
    {
      ...
      ProjectDescr:
        "This healthcare website provides patients with the convenience of booking medical treatments from the comfort of their homes. With a strong focus on enhancing the user experience, it offers a seamless and user-friendly interface. Patients can easily access a wide range of medical services and schedule appointments online. The platform's commitment to user satisfaction ensures a smooth and efficient process for patients seeking healthcare services.",
    ...
    },
    {
      ...
      ProjectDescr:
        "I built this website with a modern and responsive user interface that is intuitive and easy to use.",
    ...
    },
    {
      ...
      projectName: "Fintekk",
      ProjectDescr:
        "This is a fintek landing page.I built this website with a modern and responsive user interface that is intuitive and easy to use.",
      projectStack: ["React", "Tailwindcss"],
            ...
            return (
              ...
              >
                ...
                <div className=" flex flex-col gap-4">
                  ...
                  <p className=" flex gap-2 p-1 shadow  p-2 rounded items-center">
                    {" "}
                    <b className="text-slate-900">TOOLS:</b>{" "}
