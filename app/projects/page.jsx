...
const Projects = () => {
    const projectItems = [
        {
            ...
            projectStack: ['TOOLS:', 'NodeJs', 'React',  'Firebase', 'Tailwindcss'],
        ...
        },
        {
            ...
            projectStack: ['TOOLS:',' React','Firebase', 'Tailwindcss'],
        ...
        },
        {
            ...
            projectStack: ['TOOLS:', 'React', 'Tailwindcss', 'Git', 'Router'],
        ...
        },
        {
            ...
            projectStack:  ['TOOLS:',' React', 'Tailwindcss' , 'firebase'],
    ...
    return (
        ...
        <div className="py-[100px] pt-[150px] bg-slate-50 px-10">
                        ...
                        projectItems.map((project, index) => {
                            return <div className="flex flex-col   bg-white rounded-2xl  gap-2 p-5 rounded shadow-2xl" key={index}>
                                ...
                                <div className="max-w-[500px] flex flex-col gap-4">
                                    ...
                                    <p className=" flex gap-2 p-1 shadow  p-2 rounded items-center"> {project.projectStack.map(stack => {
                                        return <b className={`text-[15px]   ${stack === 'TOOLS'? 'text-slate-900' : 'text-slate-500'} rounded w-full text-center  capitalize`}>{stack}</b>
                                    })} </p>
